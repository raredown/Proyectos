...
public class Biblioteca extends JFrame {
	...
	public void prepararDatos(){
		...
		if(objeto != null){
			...
			int numPaginas =  Integer.parseInt((String) objeto[3]);
	...
	private void mostrarDatos(String titulo, String autor, String tema,int numPaginas, String[] formato, String estado) {
		...
		if(formato[0].compareTo("null") != 0)
			chkCartone.setSelected(true);
		if(formato[1].compareTo("null") != 0)
			chkRustica.setSelected(true);
		if(formato[2].compareTo("null") != 0)
	...
	private void rellenarLista(){
		String[] cadena = gestion.rellenarLista().split(" ");
	...
	public void eliminarDatos(){
		if(gestion.modificarOborrar(txtTitulo.getText())){
			gestion.borrar();
			gestion = null;
