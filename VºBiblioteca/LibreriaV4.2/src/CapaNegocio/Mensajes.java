...
import CapaVista.ParcialLibreria;
...
public class Mensajes {
	...
	//este recoge los errores normales como dijo que queria 
	public Mensajes(Exception e) {
		...
		if(((SQLException) e).getSQLState().equalsIgnoreCase("23000")){
			ParcialLibreria.getLblAnomalias().setText("El libro ya está insertado");
		}
		if(((SQLException) e).getSQLState().equalsIgnoreCase("S0022")){
